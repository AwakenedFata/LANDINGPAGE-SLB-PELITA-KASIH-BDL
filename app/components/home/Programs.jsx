...
import { Eye, Ear, Brain, Footprints, User } from "lucide-react";
...
export default function Programs() {
  return (
    <section id="program" className="relative py-12 lg:py-20 bg-gradient-to-b from-[#0b0378]/70 to-[#0b0378] overflow-hidden font-poppins">
      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          ...
          <p className="max-w-4xl mx-auto text-[23px] text-white/80">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-5 gap-4 sm:gap-6">
          {programs.map((program, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className="h-full p-5 sm:p-6 rounded-2xl bg-white/10 backdrop-blur-md hover:bg-white/20 transition-all duration-300 hover:scale-105">
                ...
                <p className="text-white/80 text-xs sm:text-[13px] text-justify leading-tight font-['Calibri',sans-serif]">
                  {program.description}
                </p>
              </div>
            </motion.div>
